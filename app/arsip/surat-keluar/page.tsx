                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                  <div className="flex flex-wrap gap-2">
                    {(debouncedSearchTerm || dateFilter || monthFilter) && (
                      <div className="flex flex-wrap gap-2">
                        ...
                        {monthFilter && (
                          <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-[#C8A348] text-white" style={{ fontFamily: 'Inter, sans-serif' }}>
                  ...
                  {(debouncedSearchTerm || dateFilter || monthFilter) && (
                    <button
                      ...
                      className="civic-btn-secondary px-4 py-2 rounded-lg text-sm font-medium text-[#B82025]"
                      style={{ fontFamily: 'Inter, sans-serif' }}
                    >
                      Hapus Semua Filter
                    </button>
          ...
          <div className="civic-card overflow-hidden">
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <p className="mt-4 text-[#737373] font-medium" style={{ fontFamily: 'Inter, sans-serif' }}>Memuat data surat keluar...</p>
              </div>
            ) : error ? (
              ...
              <div className="text-center py-16">
                <div className="w-20 h-20 bg-[#F7F7F7] rounded-full flex items-center justify-center mx-auto mb-6">
                  <FileOutput className="h-8 w-8 text-[#737373]" />
                </div>
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-2" style={{ fontFamily: 'Merriweather, serif' }}>Belum Ada Surat Keluar</h3>
                      ...
                      {suratList.map((surat) => (
                        <tr key={surat.id} className="hover:bg-white hover:border-l-4 hover:border-[#B82025] civic-transition group">
                          ...
                          <td className="px-6 py-5">
                            <div className="text-sm text-[#1A1A1A] max-w-xs truncate" title={surat.perihalSurat} style={{ fontFamily: 'Inter, sans-serif' }}>
                              {surat.perihalSurat}
                            </div>
                          </td>
                          <td className="px-6 py-5 whitespace-nowrap">
